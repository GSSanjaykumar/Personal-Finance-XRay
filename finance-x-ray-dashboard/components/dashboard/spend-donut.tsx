...
import { spendBreakdown } from "@/lib/data"
        ...
        <div className="relative mx-auto h-[180px] w-[180px]">
          ...
          <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center">
            <span className="text-[11px] font-medium uppercase tracking-wider text-subtle">
              {activeIndex === null ? "Total spend" : spendBreakdown[activeIndex].name}
            </span>
            <span className="tabular text-2xl font-semibold tracking-tight">
              ${(activeIndex === null ? 7700 : spendBreakdown[activeIndex].amount).toLocaleString("en-US")}
            </span>
          </div>
        </div>
