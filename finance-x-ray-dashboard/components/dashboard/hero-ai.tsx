...
const stats = [
  { id: "conf", icon: Gauge, label: "Confidence", value: "94%", note: "model certainty" },
  { id: "risk", icon: ShieldCheck, label: "Risk level", value: "Low", note: "stable cash flow" },
  { id: "proj", icon: Target, label: "Projected savings", value: "$18.4k", note: "by Dec 2026" },
]
        ...
        <div className="relative grid gap-8 p-6 lg:grid-cols-[1fr_320px] lg:p-8">
          <div>
            ...
            <h1 className="mt-5 text-pretty text-3xl font-semibold leading-[1.15] tracking-tight lg:text-[2.6rem]">
              ...
              <span className="text-[var(--accent)]">$18,400</span> this year — but dining spend is up 22%.
            </h1>

            <p className="mt-4 max-w-xl text-pretty text-[15px] leading-relaxed text-muted-foreground">
              Finance X-Ray analyzed{" "}
              <span className="font-medium text-foreground">1,284 transactions</span> across 4 linked accounts. Trimming
              dining by $240/mo and reducing subscriptions could add an estimated{" "}
              <span className="font-medium text-foreground">$420/month</span> to your runway.
            </p>
          ...
          <div className="flex flex-col gap-3">
            {stats.map((s, i) => (
              ...
              >
                ...
                <div>
                  <p className="text-[11px] font-medium uppercase tracking-wider text-subtle">{s.label}</p>
